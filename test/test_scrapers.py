...
class TestNewsSpider(unittest.TestCase):
    ...
    @mock.patch('requests.head', side_effect=mocked_requests_head)
    def test_nbcnews_homepage(self, mock_head):
        self.check_fake_html_scrape(
            'nbcnews.com.html',
    ...
    @mock.patch('requests.head', side_effect=mocked_requests_head)
    def test_nbcnews_shooting_reported_borderline_bar_grill_thousand_oaks_california(self, mock_head):
        self.check_fake_html_scrape(
    ...
    @mock.patch('requests.head', side_effect=mocked_requests_head)
    def test_abc_david_claughton(self, mock_head):
        self.check_fake_html_scrape(
            'abc-david-claughton.html',
            'https://www.abc.net.au/news/rural/david-claughton/4594706',
    ...
    @mock.patch('requests.head', side_effect=mocked_requests_head)
    def test_nzherald_12211580(self, mock_head):
        self.check_fake_html_scrape(
            'nzherald-12211580.html',
            'https://www.nzherald.co.nz/anz-sports-scene/news/article.cfm?c_id=1504448&objectid=12211580',
